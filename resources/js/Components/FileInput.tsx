...
export default function FileInput({
    ...
    return (
        <div className="w-full flex items-center justify-center">
            <label
                htmlFor={props.id}
                className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 transition ease-in-out duration-300"
            >
